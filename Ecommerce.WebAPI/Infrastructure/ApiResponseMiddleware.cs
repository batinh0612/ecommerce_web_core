...
namespace Ecommerce.WebAPI.Infrastructure
{
    public class ApiResponseMiddleware
    {
        ...
        {
            return JsonConvert.SerializeObject(new Wrappers.ApiResponse(ResponseMessageEnum.Success.GetDescription(), content, code, GetApiVersion()), JSONSettings());
        }
        ...
        private Wrappers.ApiResponse GetErrorResponse(int code, ApiError apiError)
        {
            return new Wrappers.ApiResponse(code, apiError) { Version = GetApiVersion() };
        }
