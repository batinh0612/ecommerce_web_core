    ...
    public partial class InitDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Couspons", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpirationDate = table.Column<DateTime>(maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeeMount = table.Column<decimal>(nullable: false),
                    VoucherCode = table.Column<decimal>(nullable: false),
                    TotalPrice = table.Column<decimal>(nullable: false),
                    CartStatus = table.Column<int>(nullable: false),
                    UserId = table.Column<Guid>(nullable: false),
                    CousponId = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CousponProduct", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CousponProduct_Couspons_CousponId",
                        column: x => x.CousponId,
                        principalTable: "Couspons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CousponProduct_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Districts = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderHistories_Suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CousponProduct_CousponId",
                table: "CousponProduct",
                column: "CousponId");

            migrationBuilder.CreateIndex(
                name: "IX_CousponProduct_ProductId",
                table: "CousponProduct",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderHistories_SupplierId",
                table: "OrderHistories",
                column: "SupplierId");
